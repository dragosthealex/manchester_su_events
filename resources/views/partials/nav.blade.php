    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand page-scroll" href="#page-top">
                <img class="img-responsive" src="img/logo_white.png">
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a class="page-scroll" href="#scrollto-section-2">About Us</a>
                </li>
                <li>
                    <a class="page-scroll" href="#scrollto-section-3">Services</a>
                </li>
                <li>
                    <a class="page-scroll" href="#scrollto-section-4">Contact Us</a>
                </li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
